...
const page = () => {
  ...
  return (
    <>
      <Breadcumbs title="B.Tech in Computer Science & Engineering (AI and ML)" />
        <NavTabs tabs={tabs} />
    </>
  )
}
