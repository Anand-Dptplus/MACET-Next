...
const page = () => {
    ...
    },
    {
      ...
      content: (
        <>
          <div style={{height: '40vh',display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
              <p style={{fontSize: '18px', fontWeight: '600'}}>Coming Soon Mentor</p>
            </div>
        </>
      ),
    },
  ...
  return (
    <>
      <Breadcumbs title="Humanities and Sciences" />
        <NavTabs tabs={tabs} /> 
    </>
  )
}
