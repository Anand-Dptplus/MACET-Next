...
import missionVisionData from '@/data/department/ElectricalElectronics/missionVisionData.json';
...
import faculty from '@/data/department/ElectricalElectronics/faculty.json'
...
const page = () => {
  ...
  return (
    <>
      <Breadcumbs title="B.Tech in Electrical and Electronics Engineering" />
        <NavTabs tabs={tabs} />
    </>
  )
}
