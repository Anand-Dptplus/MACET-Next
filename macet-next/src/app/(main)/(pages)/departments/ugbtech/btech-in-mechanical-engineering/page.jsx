...
import aboutCSEData from '@/data/department/MechanicalEng/aboutCSEData.json';
const MissionVision = dynamic(() => import("@/components/pages/Department/ComputerScEng/MissionVision"), {loading: () => <SharedLoader />});
import missionVisionData from '@/data/department/MechanicalEng/missionVisionData.json';
const Lab = dynamic(() => import("@/components/pages/Department/MechnicalEng/Lab"), {loading: () => <SharedLoader />});
import labData from '@/data/department/MechanicalEng/LabData.json';
const GoverningBodyContent = dynamic(() => import("@/components/pages/GoverningBodyContent"), {loading: () => <SharedLoader />})
import faculty from '@/data/department/MechanicalEng/faculty.json'
const MentorCard = dynamic(() => import("@/components/pages/Department/ComputerScEng/MentorCard"), {loading: () => <SharedLoader />})
import MentorsData from '@/data/department/MechanicalEng/MentorsData.json'
const GetInTouch = dynamic(() => import("@/components/pages/Department/ComputerScEng/GetInTouch"), {loading: () => <SharedLoader />})
import GetInTouchData from '@/data/department/MechanicalEng/GetInTouchData.json'
...
const page = () => {
      ...
      content: (
        <> 
           <Suspense fallback={<div>Loading Faculty Profile...</div>}>
            <GoverningBodyContent members={faculty} cardHeight={371}/>
          </Suspense>
        </>
      ),
    },
  ...
  return (
    <>
      <Breadcumbs title="B.Tech in Mechanical Engineering" />
        <NavTabs tabs={tabs} />
    </>
  )
}
